package ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method;
/* 
13.01.2022: Alexey created this file inside the package: ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.models
*/

import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.rarity_factory.CommonEnchantmentFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.rarity_factory.EnchantmentRarityFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.rarity_factory.MythicEnchantmentFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.rarity_factory.RareEnchantmentFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_models.Weapon;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.AxeWeaponFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.BowWeaponFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.CraftWeaponFactory;
import ru.andersen.app.user_patterns.alexey.patterns.creational.factory_method.weapon_factory.SwordWeaponFactory;
